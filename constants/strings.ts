...
export const Strings = {
  ...
  profile: {
    ...
    deleteAccountDesc: 'حذف حسابك وجميع بياناتك الطبية نهائياً',
    deleteAccountConfirmTitle: 'تأكيد حذف الحساب',
    deleteAccountConfirmDesc: 'هل أنت متأكد من رغبتك في حذف حسابك نهائياً؟ هذا الإجراء لا يمكن التراجع عنه وسيتم مسح جميع بياناتك، قياساتك، واشتراكك بالكامل من النظام.',
    deleteAccountSuccess: 'تم حذف حسابك بنجاح. نأسف لمغادرتك',
    deleteAccountError: 'فشل حذف الحساب. يرجى المحاولة مرة أخرى.',
    privacyPolicy: 'سياسة الخصوصية',
    termsOfService: 'شروط الخدمة',
    legalDisclaimer: 'بإنشاء حسابك أو استخدام التطبيق، فإنك توافق على شروط الخدمة وسياسة الخصوصية الخاصة بنا.',
  },
} as const;
